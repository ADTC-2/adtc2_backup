...
<body>
  <nav class="navbar navbar-dark bg-dark">
    <a href="https://codigoquatro.com.br/adtc2/index.php" class="navbar-brand">Trabalhos ADTC2</a>
  </nav>
  <div class="container">
   <form novalidate class="needs-validation" action="procedimento_cad_servico.php"  method="POST">
    ...
    <div class="form-row">     
        ...
        <label for="nome">Data do Evento</label>
           <input type="text" name="dt_evento" class="form-control is-valid" id="qtde" required>
        </div>
    </div><!-- end div-form-row-->
    ...
    <a  href="tela_lista_servico.php"class="btn btn-info btn-block">Lista Eventos Agendados</a>  
    <a  href="tela_relatorio_servico.php"class="btn btn-primary btn-block">Relatório</a>           
   </form><!-- end form-->
