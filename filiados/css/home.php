  ...
  <div class="sidebar">
    ...
    <nav class="mt-2">
      <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
        ...
        <li class="nav-item">
            <a href="tela_relatorio_dizimo.php" class="nav-link">
                <i class="nav-icon fas fa-chart-bar"></i>
                <p>Total(Dizimo & Ofertas)</p>
            </a>
        </li>
        <li class="nav-item">
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Dízimos</h1>
          </div>
        </div>
      </div>
    </div>
        ...
        <div class="row">
            <div class="col-lg-3 col-6">
                <div class="card card-primary">
                    ...
                    <div class="card-body">
                        <p>
                            Visualizar todos os dízimos que foram lançados.
                        </p>
                    </div>
                    <div class="card-footer">
                        <a href="../dizimo/tela_pesquisar_dizimo.php" class="btn btn-primary">Entrar <i class="fas fa-arrow-circle-right"></i></a>
                    </div>
                </div>
            </div>
            <div class="col-lg-3 col-6">
                <div class="card card-primary">
                    <div class="card-header">
                        <h3 class="card-title"><i class="nav-icon fas fa-coins"> </i>Lançamentos</h3>
                    </div>
                    <div class="card-body">
                        <p>
                            Realizar lançamentos de dízimos do dia.
                        </p>
                    </div>
                    <div class="card-footer">
                        <a href="tela_cadastro.php" class="btn btn-primary">Entrar <i class="fas fa-arrow-circle-right"></i></a>
                    </div>
                </div>
            </div>
        </div>
