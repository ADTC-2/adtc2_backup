...
<body>
  ...
  <div class="container">
   <form novalidate class="needs-validation" action="../frente.php"  method="GET">
    ...
    <div class="form-row">     
        <div class="col form-group">   
           <input  style="text-align: center;"  type="hidden" name="nome" class="form-control is-valid" id="qtde" value="<?php echo $_SESSION['nome'];?>" required>
           <input  style="text-align: center;"  type="hidden" name="congregacao" class="form-control is-valid" id="qtde" value="<?php echo $congregacao ;?>" required>
        </div>
    </div><!-- end div-form-row-->
