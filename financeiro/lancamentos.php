    ...
    <div class="wrapper">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <a href="../index_tesoureiro.php" class="brand-link">
                <img src="../imagens/img_carteira/logo_red.png" alt="ADTC II" class="brand-image img-circle elevation-3"
                    style="opacity: .8">
                ...
                <div class="row">
                    <div class="col-lg-3 col-6">
                        ...
                        <div class="small-box bg-success">
                            ...
                            <a href="../dizimo/tela_pesquisar_dizimo.php" class="small-box-footer">Dízimos Lançados<i
                                    class="fas fa-arrow-circle"></i></a>
                        </div>
                    </div>
                    <!-- ./col -->
                ...
                <div class="row">
                    <div class="col-lg-3 col-6">
                        ...
                        <div class="small-box bg-primary">
                            ...
                            <a href="tela_cadastro.php" class="small-box-footer">Dízimos<i
                                    class="fas fa-arrow-circle"></i></a>
                        </div>
                    </div>
                    <!-- ./col -->
