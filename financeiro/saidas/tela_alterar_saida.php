   ...
   <div class="form-row">        
    ...
    <div class="form-row">        
        <div class="col form-group">
           ...
           <input type="date" name="datasaida" class="form-control is-valid" id="datasaida" value="<?php echo date("d/m/Y", strtotime($linhas['datasaida'])); ?>" required>
        </div>
    </div><!-- end div-form-row-->  
    ...
    <div class="form-row">
        ...
        <label for="nome">Responsavel</label>
           <select name="responsavel" id="tipo_evento" class="custom-select is-valid"required value="<?php echo $linhas['responsavel']; ?>">
