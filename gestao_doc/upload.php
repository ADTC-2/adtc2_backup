        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h3 class="m-0 text-dark">Gestão de Documentos | Upload</h3>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="row d-flex justify-content-center">
                        <div class="col-lg-3 col-6">
                            <div class="card card-primary">
                                ...
                                <div class="card-footer">
                                    <a href="tela_upload_digitalizados.php" class="btn btn-primary">Entrar <i
                        ...
                        <div class="col-lg-3 col-6">
                            <div class="card card-primary">
                                ...
                                <div class="card-footer">
                                    <a href="tela_upload_modelos.php" class="btn btn-primary">Entrar <i
                                            class="fas fa-arrow-circle-right"></i></a>
                                </div>
                            </div>
                        </div>
