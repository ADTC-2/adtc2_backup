...
<head>
    ...
    .main-footer {
        ...
        bottom: 0;
        /* Coloca o rodapé no fundo da página */
        width: 100%;
        /* Garante que o rodapé ocupe toda a largura da página */
        text-align: center;
        /* Centraliza o conteúdo do rodapé */
        background-color: #f8f9fa;
        /* Cor de fundo do rodapé (opcional) */
        padding: 10px 0;
        /* Espaçamento interno do rodapé (opcional) */
    }
    </style>
</head>
...
<body class="hold-transition sidebar-mini layout-fixed">
                ...
                <div class="container-fluid">
                    <div class="row d-flex justify-content-center">
                        <div class="col-lg-12 col-12">
                            <div class="container">
                                <form id="documentForm" enctype="multipart/form-data" onsubmit="limparFormulario()">
    ...
    $(document).ready(function() {
        $('#documentForm').submit(function(e) {
            ...
            $.ajax({
                url: 'cadastro_doc.php', // Substitua pelo seu script de inserção real
                type: 'POST',
                data: formData,
                async: false,
                cache: false,
